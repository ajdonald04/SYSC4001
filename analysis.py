...
if __name__ == "__main__":
    fcfs_results = analyze_execution_log("execution_FCFS_2.txt")
    ep_results = analyze_execution_log("execution_EP_2.txt")
    rr_results = analyze_execution_log("execution_RR_2.txt")
